...
module.exports = {
  ...
  theme: path.resolve(__dirname, './theme/lib/node/index.js'),//这里使用本地主题 打开此注释将使用本地主题 此处和theme: 'aurora'，只能二选一
  ...
  themeConfig: {
    ...
    * */
    ...
    //https://console.leancloud.app/login
    //https://vercel.com/waysn39/hyakutake-cyga
    comment: {
      //是否显示评论
      showComment: true,
      serverURL: 'https://hyakutake-cyga-3x49x9agt-waysn39.vercel.app/',
      emojis: [
