<template>
  <div class="common"
    ...
    <Navbar :show-header-bg="showHeaderBg"
    ...
    <!--<social-spin/>-->
    <style-menu :theme-property="themeProperty"
    ...
    <div class="theme-container"
      ...
      <div class="page-sidebar">
        ...
        <div :class="{'content': !isHomePage}">
          <div :id="getArticleId"
               :class="{'article-page-parent-pro': !isHomePage}"
               class="article-page-parent">
            <div :class="{noShowSidebar: getNoShowSidebar}"
    ...
    <div id="set-bg"
         ...
         'px; --backgroundImageUrl: url(' + $store.state.homeWps + ')'"></div>
    <div id="posterShade"
         :class="{posterShade: $store.state.showPosterShadow}">
...
export default defineComponent({
  ...
  computed: {
    ...
    setBodyStyle() {
      ...
      return (
        this.$store.state.fontColorStyle +
        ";" +
        this.$store.state.fontFamilyStyle
      );
    },
  },
  methods: {
  ...
  mounted() {
    ...
    if (frontmatter.value.home) {
      ...
      let descriptionDom = document.querySelectorAll(
      ...
      if (keywordDom === null) {
        //head中没有keyword 添加一个
        let keywordMeta = $(
          '<meta name="keyword" content="' + keywordValue + '">'
        ).get(0);
    ...
    if (
      ...
      this.themeProperty.mobilePageSidebar !== undefined
    ) {
