...
export default defineComponent({
  ...
  created() {
    ...
    //从配置文件中，获取首页壁纸
    let homeWps = [];
    baseService.get("/open/open/get/background/image").then((res) => {
  ...
  mounted() {
    ...
    if (screen < 500) {
      ...
      if (
        this.themeProperty.homeWpsMobile !== undefined &&
